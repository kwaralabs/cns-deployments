...
```
```
curl -o setup.sh 'https://raw.githubusercontent.com/kwaralabs/cns-deployments/refs/heads/main/docker-based-deployments/base-erpnext-hrms/setup-erpnext-hrms.sh'
```
```
chmod +x setup.sh
```
